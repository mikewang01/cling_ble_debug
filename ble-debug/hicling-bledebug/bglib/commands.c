...
void ble_rsp_system_read_memory(const struct ble_msg_system_read_memory_rsp_t *msg)
{
 ...
 __attribute__((weak)) void ble_rsp_system_get_info(const struct ble_msg_system_get_info_rsp_t *msg)
{
}
...
void ble_rsp_gap_discover(const struct ble_msg_gap_discover_rsp_t *msg)
{
 ...
 __attribute__((weak)) void ble_rsp_gap_connect_direct(const struct ble_msg_gap_connect_direct_rsp_t *msg)
{
}
...
void ble_evt_attributes_status(const struct ble_msg_attributes_status_evt_t *msg)
{
 ...
 __attribute__((weak)) void ble_evt_connection_status(const struct ble_msg_connection_status_evt_t *msg)
{
}
...
void ble_evt_connection_raw_rx(const struct ble_msg_connection_raw_rx_evt_t *msg)
{
 ...
 __attribute__((weak)) void ble_evt_connection_disconnected(const struct ble_msg_connection_disconnected_evt_t *msg)
{
}
...
void ble_evt_attclient_indicated(const struct ble_msg_attclient_indicated_evt_t *msg)
{
 ...
 __attribute__((weak)) void ble_evt_attclient_procedure_completed(const struct ble_msg_attclient_procedure_completed_evt_t *msg)
{
}

 __attribute__((weak)) void ble_evt_attclient_group_found(const struct ble_msg_attclient_group_found_evt_t *msg)
{
}
...
void ble_evt_attclient_attribute_found(const struct ble_msg_attclient_attribute_found_evt_t *msg)
{
 ...
 __attribute__((weak)) void ble_evt_attclient_find_information_found(const struct ble_msg_attclient_find_information_found_evt_t *msg)
{
}

 __attribute__((weak)) void ble_evt_attclient_attribute_value(const struct ble_msg_attclient_attribute_value_evt_t *msg)
{
}
...
void ble_evt_sm_bond_status(const struct ble_msg_sm_bond_status_evt_t *msg)
{
 ...
 __attribute__((weak)) void ble_evt_gap_scan_response(const struct ble_msg_gap_scan_response_evt_t *msg)
{
}
